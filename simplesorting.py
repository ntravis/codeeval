"""
SIMPLE SORTING
CHALLENGE DESCRIPTION: Write a program which sorts numbers.
...
OUTPUT SAMPLE: Print sorted numbers in the following way. Please note, that you need to print the numbers till the 3rd
